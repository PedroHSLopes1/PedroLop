...
public class ManutencaoPiloto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Brasil ", "Alemanha", "Japão" }));

        jLabel4.setText("País");

        jLabel5.setText("Equipe");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ferrari", "Mercedes ", "Renault", "Red Bull" }));
